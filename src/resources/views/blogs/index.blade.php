...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1 class="jumbotron-heading">GBlogへようこそ</h1>
      <p>
        <a href="/blogs/create" class="btn btn-primary my-2">早速ブログを開始する</a>
        <a href="#" class="btn btn-secondary my-2">あとで</a>
      </p>
    </div>
  </section>
  @endif
        ...
        <div class="col-md-4">
          <div class="card mb-4 box-shadow">
            ...
            @if ($blog->header_image_url)
              <img src="{{ asset('storage/avatar/' . $blog->header_image_url) }}" alt="avatar" width="100%" height="200px"/>
            @else
            ...
            <div class="card-body">
              <a href="/blogs/{{ $blog->id }}">
                ...
                <div class="d-flex justify-content-end align-items-center">
                  <small class="text-muted text-right">{{$blog->last_posted_at}}</small>
                </div>
              </a>
            </div>
          </div>
